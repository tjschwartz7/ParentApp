...
public class EmailClient {
    ...
    private static final String SMTP_USER = "your-email@example.com"; // Replace with your email
    private static final String SMTP_PASSWORD = "your-password"; // Replace with your email password
